...
/** Modulo de testing del modulo torrentfile */
...
// test para lectura de archivos bittorrent
func TestOpen(t *testing.T) {
	torrent, err := Open("test/archlinux-2019.12.01-x86_64.iso.torrent")

	// verificamos si existe errores
	require.Nil(t, err)

	goldenPath := "test/archlinux-2019.12.01-x86_64.iso.torrent.golden.json"
...
// test a la transformacion de los datos bencode a la interfaz
